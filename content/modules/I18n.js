...
(function () {
  ...
  const MESSAGES = {
    zh: {
      ...
      domInspectorTip: '单击选取该元素区域（ESC 退出）',
      notifySelectionAdded: '已添加选区框。',
    ...
    en: {
      ...
      domInspectorTip: 'Click to add this element as a selection box (ESC to exit)',
      notifySelectionAdded: 'Selection box added.',
      toolbarToggleOn: 'Hide Ruler',
      toolbarToggleOff: 'Show Ruler',
      toolbarSettings: 'Settings',
      toolbarCoffee: 'Buy Author a Coffee',
      toolbarClose: 'Close Plugin',
    ...
    ja: {
      ...
      domInspectorTip: 'クリックでこの要素を選択枠として追加（ESCで終了）',
      notifySelectionAdded: '選択枠を追加しました。',
      toolbarToggleOn: 'ルーラーを隠す',
      toolbarToggleOff: 'ルーラーを表示',
      toolbarSettings: '設定',
      toolbarCoffee: '作者にコーヒーを',
      toolbarClose: 'プラグインを閉じる',
    ...
    ko: {
      ...
      domInspectorTip: '클릭하여 이 요소를 선택 영역으로 추가 (ESC로 종료)',
      notifySelectionAdded: '선택 영역을 추가했습니다.',
      toolbarToggleOn: '눈금자 숨기기',
      toolbarToggleOff: '눈금자 표시',
      toolbarSettings: '설정',
      toolbarCoffee: '작성자에게 커피 쏘기',
      toolbarClose: '플러그인 닫기',
    ...
    es: {
      ...
      domInspectorTip: 'Haz clic para añadir este elemento como selección (ESC para salir)',
      notifySelectionAdded: 'Cuadro de selección añadido.',
    ...
    fr: {
      ...
      domInspectorTip: 'Cliquez pour ajouter cet élément comme sélection (ESC pour quitter)',
      notifySelectionAdded: 'Cadre de sélection ajouté.',
    ...
    de: {
      ...
      domInspectorTip: 'Klicken, um dieses Element als Auswahl hinzuzufügen (ESC zum Beenden)',
      notifySelectionAdded: 'Auswahlrahmen hinzugefügt.',
    ...
    ru: {
      ...
      domInspectorTip: 'Нажмите, чтобы добавить этот элемент как выделение (ESC для выхода)',
      notifySelectionAdded: 'Рамка выделения добавлена.',
